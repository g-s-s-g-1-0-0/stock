  ...
  swing: {
    ...
    '3': [
      ...
      },
      {
        label: '설명',
        value: [
          '전략 1·2와 같은 잣대로, QQQ 현재가가 200일 평균선보다 몇 % 위/아래인지(이격도)를 봅니다. -3% ~ +9% 사이면 “정상장”, 즉 무너지지도 과열되지도 않은 평상시 시장입니다.',
          '-3%보다 아래면 하락장, +9%보다 위면 횡보장 고점, 급락 뒤 다시 올라온 구간이면 회복장으로 따로 봅니다. 전략 3은 이 셋을 뺀 평상시 구간에서만 짧게 씻긴 자리를 노립니다.',
      ...
      },
      {
        label: '청산',
        value: [
          'QQQ가 200일 평균선보다 +9% 넘게 올라가면(횡보장 고점) 종가 기준으로 청산합니다.',
      ...
      },
      {
        label: '관망',
        value: [
          '보유 중에는 QQQ가 정상장 범위(200일 평균선 대비 -3% ~ +9%)이고 현재가가 MA200 위인지만 보면 매수 의견을 유지합니다.',
