...
def build_snapshot_row(
    ...
    *,
    ...
    return {
        ...
        "atrPct": parse_number(row.get("ATR (14, %)")),
        "dist52wHigh": parse_number(row.get("52주 신고가 대비")),
        "daysSince52wHigh": parse_number(row.get("52주 신고가 후 경과일")),
        "rs20": parse_number(row.get("QQQ 대비 상대강도 (20일)")),
        "obv20": parse_number(row.get("OBV 누적강도 (20일)")),
        "williamsR": parse_number(row.get("Williams %R (14)")),
