"""Frozen snapshot of the legacy A-H rules, for overlap research only.

Copied verbatim from `calculator/rules.py` at commit 1b9bc899^ (the last commit
before A-H was replaced by Strategy 1/2). Kept here so strategy-overlap
backtests can still evaluate A-H entries; the live service no longer uses them.
"""
